...
const socialLinks = [
  ...
  {
    name: 'Email',
    url: 'mailto:kskreddy2k7@gmail.com',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
    ...
    color: 'hover:text-red-400 hover:shadow-red-400/30',
  },
]
    ...
    <div className={`flex gap-4 ${className}`}>
      {socialLinks.map((link, i) => (
        <motion.a
          ...
          className={`p-3 glass-card text-gray-400 transition-all duration-300 ${link.color} hover:shadow-lg`}
        >
          {link.icon}
        </motion.a>
      ))}
